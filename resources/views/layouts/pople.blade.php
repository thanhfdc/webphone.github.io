...
<html>
            ...
            <div id="container">
                <div id="header-wp">
                        ...
                        <div class="wp-inner">
                            ...
                            <div id="main-menu-wp" class="fl-right">
                                <ul id="main-menu" class="clearfix">
                                    <li>
                                        <a href="http://localhost/project_unitop_wedsite_shop/" title="">Sản phẩm</a>
                                    </li>
                                    <li>
                    ...
                    <div id="head-body" class="clearfix">
                        <div class="wp-inner">
                            <a href="{{asset('/')}}" title="" id="logo" class="fl-left"><img src="{{asset('public/image/icons/logo.png')}}"/></a>
                            <div id="search-wp" class="fl-left">
                                <form  action="#">
                                    <input type="text" name="keyword" value="{{old('keyword')}}" id="s"  placeholder="Nhập từ khóa tìm kiếm tại đây!">
                            ...
                            <div id="action-wp" class="fl-right">
                                ...
                                <div id="cart-wp" class="fl-right">
                                                ...
                                                @foreach (Cart::content() as $row)
                                                    <li class="clearfix">
                                                        ...
                                                        <div class="info fl-right">
                                                            ...
                                                            <p class="price">Giá : {{number_format($row->price,0,',','.')}}</p>
                                    ...
                                    <div id="dropdown" style="min-height:10px">
                                         <p class="title fl-left" style="color:red;">Không có sản phẩm nào trong giỏ hàng</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
  ...
  <!-- end header -->
  <div id="wp-content">
    {{-- Nhung giao dien cac trang vao day --}}
 @yield('content')
    ...
    <div id="foot-body">
        <div class="wp-inner clearfix">
            <div class="block" id="info-company">
                ...
                <div id="payment">
                    <div class="thumb">
                        <img src="{{asset('public/image/icons/img-foot.png')}}" alt="">
                    </div>
                </div>
            </div>
